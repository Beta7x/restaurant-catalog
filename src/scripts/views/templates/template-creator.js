...
const createDetailRestaurant = (restaurant) => `
            ...
            <section class="restaurant__detail__section" tabindex="0" id="#main">
                ...
                Categories:
                <p class="restaurant__detail__category">  ${restaurant.categories
...
`;
export {
  createItemRestaurant, createDetailRestaurant, createLikeButtonTemplate, createLikedButtonTemplate,
};
